...
SECRET_KEY = 'django-insecure-eub*h_wjpe4q)=b-ktrg4f%cj+3yvejjm@s(t2d%clalm$ip&-'
...
INSTALLED_APPS = [
    "daphne", #Servidor Channel de ASGI para manejar las conceciones de websockets
...
TEMPLATES = [
    {   
        # Agregamos un nuevo directorio para los templates
        'DIRS': ['templates'],
...
# Colocamos el nuevo WSGI con su chanel
